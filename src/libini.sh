...
#  DESCRIPTION
#    инициализировать валидные переменные <varname> и/или перечисленные в <csv;> 
#    соответствующими значениями строк секций <section> конфигурационного ini
#    файла <file> и ему родственных.
#  INPUTS
...
#     varname - валидная переменная для приема перечисленных в CSV-строке 
#               "безымянных" значений секции. Если varname опущена, то валидной
#               переменной считается имя секции section
#  RETURN VALUE
#     0  - Выполнено успешно
